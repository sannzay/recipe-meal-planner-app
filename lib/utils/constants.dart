...
class SampleRecipes {
  static const List<Map<String, dynamic>> recipes = [
    ...
    },
    {
      ...
      'dietaryTags': [DietaryTags.vegetarian, DietaryTags.glutenFree],
      'ingredients': [
        {'name': 'Greek yogurt', 'quantity': '1', 'unit': 'cup', 'category': IngredientCategories.dairy},
        {'name': 'Mixed berries', 'quantity': '1', 'unit': 'cup', 'category': IngredientCategories.produce},
        {'name': 'Granola', 'quantity': '1/2', 'unit': 'cup', 'category': IngredientCategories.pantry},
        {'name': 'Honey', 'quantity': '2', 'unit': 'tbsp', 'category': IngredientCategories.condiments},
        {'name': 'Chia seeds', 'quantity': '1', 'unit': 'tbsp', 'category': IngredientCategories.nuts},
      ],
      'instructions': [
    ...
    },
    {
      ...
      'dietaryTags': [DietaryTags.vegetarian],
      'ingredients': [
        {'name': 'Bread slices', 'quantity': '8', 'unit': 'thick', 'category': IngredientCategories.pantry},
        {'name': 'Eggs', 'quantity': '4', 'unit': 'large', 'category': IngredientCategories.dairy},
        {'name': 'Milk', 'quantity': '1', 'unit': 'cup', 'category': IngredientCategories.dairy},
        {'name': 'Vanilla extract', 'quantity': '1', 'unit': 'tsp', 'category': IngredientCategories.baking},
        {'name': 'Cinnamon', 'quantity': '1', 'unit': 'tsp', 'category': IngredientCategories.spices},
        {'name': 'Butter', 'quantity': '2', 'unit': 'tbsp', 'category': IngredientCategories.dairy},
        {'name': 'Maple syrup', 'quantity': '1/4', 'unit': 'cup', 'category': IngredientCategories.condiments},
      ],
      'instructions': [
    ...
    },
    {
      ...
      'ingredients': [
        {'name': 'Bread slices', 'quantity': '6', 'unit': 'slices', 'category': IngredientCategories.pantry},
        {'name': 'Turkey breast', 'quantity': '8', 'unit': 'oz', 'category': IngredientCategories.meat},
        {'name': 'Bacon', 'quantity': '4', 'unit': 'strips', 'category': IngredientCategories.meat},
        {'name': 'Avocado', 'quantity': '1', 'unit': 'medium', 'category': IngredientCategories.produce},
        {'name': 'Tomato', 'quantity': '1', 'unit': 'medium', 'category': IngredientCategories.produce},
        {'name': 'Lettuce', 'quantity': '4', 'unit': 'leaves', 'category': IngredientCategories.produce},
        {'name': 'Mayonnaise', 'quantity': '2', 'unit': 'tbsp', 'category': IngredientCategories.condiments},
        {'name': 'Salt', 'quantity': '1/4', 'unit': 'tsp', 'category': IngredientCategories.spices},
        {'name': 'Black pepper', 'quantity': '1/4', 'unit': 'tsp', 'category': IngredientCategories.spices},
      ],
      'instructions': [
    ...
    },
    {
      ...
      'dietaryTags': [DietaryTags.meat],
      'ingredients': [
        {'name': 'Chicken breasts', 'quantity': '4', 'unit': 'large', 'category': IngredientCategories.meat},
        {'name': 'Breadcrumbs', 'quantity': '1', 'unit': 'cup', 'category': IngredientCategories.pantry},
        {'name': 'Parmesan cheese', 'quantity': '1/2', 'unit': 'cup', 'category': IngredientCategories.dairy},
        {'name': 'Eggs', 'quantity': '2', 'unit': 'large', 'category': IngredientCategories.dairy},
        {'name': 'Marinara sauce', 'quantity': '2', 'unit': 'cups', 'category': IngredientCategories.canned},
        {'name': 'Mozzarella cheese', 'quantity': '1', 'unit': 'cup', 'category': IngredientCategories.dairy},
        {'name': 'Flour', 'quantity': '1/2', 'unit': 'cup', 'category': IngredientCategories.baking},
        {'name': 'Olive oil', 'quantity': '1/4', 'unit': 'cup', 'category': IngredientCategories.oils},
        {'name': 'Basil', 'quantity': '2', 'unit': 'tbsp', 'category': IngredientCategories.spices},
      ],
      'instructions': [
    ...
    },
    {
      ...
      'dietaryTags': [DietaryTags.vegetarian, DietaryTags.vegan, DietaryTags.glutenFree],
      'ingredients': [
        {'name': 'Chickpeas', 'quantity': '2', 'unit': 'cans', 'category': IngredientCategories.canned},
        {'name': 'Tahini', 'quantity': '1/4', 'unit': 'cup', 'category': IngredientCategories.condiments},
        {'name': 'Lemon juice', 'quantity': '3', 'unit': 'tbsp', 'category': IngredientCategories.produce},
        {'name': 'Garlic', 'quantity': '2', 'unit': 'cloves', 'category': IngredientCategories.produce},
        {'name': 'Olive oil', 'quantity': '2', 'unit': 'tbsp', 'category': IngredientCategories.oils},
        {'name': 'Cumin', 'quantity': '1', 'unit': 'tsp', 'category': IngredientCategories.spices},
        {'name': 'Salt', 'quantity': '1/2', 'unit': 'tsp', 'category': IngredientCategories.spices},
        {'name': 'Paprika', 'quantity': '1', 'unit': 'tsp', 'category': IngredientCategories.spices},
      ],
    ...
    },
    {
      ...
      'dietaryTags': [DietaryTags.vegetarian, DietaryTags.vegan, DietaryTags.glutenFree],
      'ingredients': [
        {'name': 'Dates', 'quantity': '1', 'unit': 'cup', 'category': IngredientCategories.produce},
        {'name': 'Almonds', 'quantity': '1/2', 'unit': 'cup', 'category': IngredientCategories.nuts},
        {'name': 'Cashews', 'quantity': '1/2', 'unit': 'cup', 'category': IngredientCategories.nuts},
        {'name': 'Cocoa powder', 'quantity': '2', 'unit': 'tbsp', 'category': IngredientCategories.baking},
        {'name': 'Coconut oil', 'quantity': '1', 'unit': 'tbsp', 'category': IngredientCategories.oils},
        {'name': 'Vanilla extract', 'quantity': '1', 'unit': 'tsp', 'category': IngredientCategories.baking},
        {'name': 'Salt', 'quantity': '1/4', 'unit': 'tsp', 'category': IngredientCategories.spices},
        {'name': 'Shredded coconut', 'quantity': '1/4', 'unit': 'cup', 'category': IngredientCategories.nuts},
      ],
      'instructions': [
    ...
    // INTERNATIONAL CUISINES
    {
      ...
      'category': RecipeCategories.japanese,
      'dietaryTags': [DietaryTags.meat],
      'ingredients': [
        {'name': 'Ramen noodles', 'quantity': '4', 'unit': 'servings', 'category': IngredientCategories.pantry},
        {'name': 'Pork belly', 'quantity': '1', 'unit': 'lb', 'category': IngredientCategories.meat},
        {'name': 'Soft-boiled eggs', 'quantity': '4', 'unit': 'large', 'category': IngredientCategories.dairy},
        {'name': 'Green onions', 'quantity': '4', 'unit': 'stalks', 'category': IngredientCategories.produce},
        {'name': 'Nori sheets', 'quantity': '4', 'unit': 'sheets', 'category': IngredientCategories.seafood},
        {'name': 'Miso paste', 'quantity': '3', 'unit': 'tbsp', 'category': IngredientCategories.condiments},
        {'name': 'Soy sauce', 'quantity': '2', 'unit': 'tbsp', 'category': IngredientCategories.condiments},
        {'name': 'Sesame oil', 'quantity': '1', 'unit': 'tbsp', 'category': IngredientCategories.oils},
        {'name': 'Garlic', 'quantity': '3', 'unit': 'cloves', 'category': IngredientCategories.produce},
      ],
      'instructions': [
    ...
    },
    {
      ...
      'servings': 6,
      'difficulty': DifficultyLevels.medium,
      'category': RecipeCategories.indian,
      'dietaryTags': [DietaryTags.meat, DietaryTags.glutenFree],
      'ingredients': [
        {'name': 'Chicken thighs', 'quantity': '2', 'unit': 'lbs', 'category': IngredientCategories.meat},
        {'name': 'Tomato sauce', 'quantity': '28', 'unit': 'oz', 'category': IngredientCategories.canned},
        {'name': 'Heavy cream', 'quantity': '1', 'unit': 'cup', 'category': IngredientCategories.dairy},
        {'name': 'Butter', 'quantity': '4', 'unit': 'tbsp', 'category': IngredientCategories.dairy},
        {'name': 'Onion', 'quantity': '1', 'unit': 'large', 'category': IngredientCategories.produce},
        {'name': 'Garlic', 'quantity': '4', 'unit': 'cloves', 'category': IngredientCategories.produce},
        {'name': 'Ginger', 'quantity': '2', 'unit': 'tbsp', 'category': IngredientCategories.produce},
        {'name': 'Garam masala', 'quantity': '2', 'unit': 'tsp', 'category': IngredientCategories.spices},
        {'name': 'Turmeric', 'quantity': '1', 'unit': 'tsp', 'category': IngredientCategories.spices},
        {'name': 'Basmati rice', 'quantity': '2', 'unit': 'cups', 'category': IngredientCategories.grains},
      ],
      'instructions': [
    ...
    },
    {
      ...
      'servings': 6,
      'difficulty': DifficultyLevels.medium,
      'category': RecipeCategories.french,
      'dietaryTags': [DietaryTags.vegetarian, DietaryTags.vegan, DietaryTags.glutenFree],
      'ingredients': [
        {'name': 'Eggplant', 'quantity': '1', 'unit': 'large', 'category': IngredientCategories.produce},
        {'name': 'Zucchini', 'quantity': '2', 'unit': 'medium', 'category': IngredientCategories.produce},
        {'name': 'Yellow squash', 'quantity': '2', 'unit': 'medium', 'category': IngredientCategories.produce},
        {'name': 'Tomatoes', 'quantity': '4', 'unit': 'medium', 'category': IngredientCategories.produce},
        {'name': 'Onion', 'quantity': '1', 'unit': 'large', 'category': IngredientCategories.produce},
        {'name': 'Bell peppers', 'quantity': '2', 'unit': 'medium', 'category': IngredientCategories.produce},
        {'name': 'Garlic', 'quantity': '4', 'unit': 'cloves', 'category': IngredientCategories.produce},
        {'name': 'Herbes de Provence', 'quantity': '2', 'unit': 'tbsp', 'category': IngredientCategories.spices},
        {'name': 'Olive oil', 'quantity': '1/4', 'unit': 'cup', 'category': IngredientCategories.oils},
      ],
      'instructions': [
    ...
    },
    {
      ...
      'servings': 4,
      'difficulty': DifficultyLevels.easy,
      'category': RecipeCategories.chinese,
      'dietaryTags': [DietaryTags.vegetarian],
      'ingredients': [
        {'name': 'Cooked rice', 'quantity': '3', 'unit': 'cups', 'category': IngredientCategories.grains},
        {'name': 'Eggs', 'quantity': '3', 'unit': 'large', 'category': IngredientCategories.dairy},
        {'name': 'Peas', 'quantity': '1', 'unit': 'cup', 'category': IngredientCategories.produce},
        {'name': 'Carrots', 'quantity': '1', 'unit': 'cup', 'category': IngredientCategories.produce},
        {'name': 'Green onions', 'quantity': '4', 'unit': 'stalks', 'category': IngredientCategories.produce},
        {'name': 'Soy sauce', 'quantity': '3', 'unit': 'tbsp', 'category': IngredientCategories.condiments},
        {'name': 'Sesame oil', 'quantity': '1', 'unit': 'tbsp', 'category': IngredientCategories.oils},
        {'name': 'Garlic', 'quantity': '2', 'unit': 'cloves', 'category': IngredientCategories.produce},
    ...
    },
    {
      ...
      'dietaryTags': [DietaryTags.vegetarian, DietaryTags.glutenFree],
      'ingredients': [
        {'name': 'Corn on the cob', 'quantity': '4', 'unit': 'ears', 'category': IngredientCategories.produce},
        {'name': 'Mayonnaise', 'quantity': '1/4', 'unit': 'cup', 'category': IngredientCategories.condiments},
        {'name': 'Cotija cheese', 'quantity': '1/2', 'unit': 'cup', 'category': IngredientCategories.dairy},
        {'name': 'Chili powder', 'quantity': '1', 'unit': 'tsp', 'category': IngredientCategories.spices},
        {'name': 'Lime', 'quantity': '2', 'unit': 'medium', 'category': IngredientCategories.produce},
        {'name': 'Cilantro', 'quantity': '2', 'unit': 'tbsp', 'category': IngredientCategories.produce},
        {'name': 'Salt', 'quantity': '1/2', 'unit': 'tsp', 'category': IngredientCategories.spices},
      ],
      'instructions': [
    ...
    },
    {
      ...
      'dietaryTags': [DietaryTags.meat, DietaryTags.glutenFree],
      'ingredients': [
        {'name': 'Short-grain rice', 'quantity': '2', 'unit': 'cups', 'category': IngredientCategories.grains},
        {'name': 'Beef', 'quantity': '1', 'unit': 'lb', 'category': IngredientCategories.meat},
        {'name': 'Spinach', 'quantity': '2', 'unit': 'cups', 'category': IngredientCategories.produce},
        {'name': 'Carrots', 'quantity': '1', 'unit': 'cup', 'category': IngredientCategories.produce},
        {'name': 'Bean sprouts', 'quantity': '1', 'unit': 'cup', 'category': IngredientCategories.produce},
        {'name': 'Gochujang', 'quantity': '3', 'unit': 'tbsp', 'category': IngredientCategories.condiments},
        {'name': 'Sesame oil', 'quantity': '2', 'unit': 'tbsp', 'category': IngredientCategories.oils},
        {'name': 'Soy sauce', 'quantity': '2', 'unit': 'tbsp', 'category': IngredientCategories.condiments},
        {'name': 'Fried egg', 'quantity': '4', 'unit': 'large', 'category': IngredientCategories.dairy},
      ],
      'instructions': [
